// COPY OF CARRIER-RECEIVER-BASEBAND CODE BUT WITH RECEIVER DISABLED
 ...
 */
 ...
 int main() {
     ...
     */
     ...
     // DISABLED: Local carrier generation (use external carrier)
     /*
         ...
         switch(evt){
             ...
             case no_evt:
                 if (rx_ready){
                     ...
                     // DISABLED: Local carrier start/stop (assume external)
                     /*
                     startCarrier();
                     sleep_ms(1);
                     */
 
                     printf("Sending backscatter data...\n");
